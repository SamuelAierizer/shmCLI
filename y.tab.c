...
{
       0,    63,    63,    64,    67,    68,    69,    72,    73,    76,
      77,    80,    81,    84,    87,    90,    92,    93,    94,    95,
      98,    99,   102,   103,   106,   107,   110,   111,   114,   115,
     118,   119,   122,   123,   126,   127,   130,   131,   139,   140,
...
{
  "$end", "error", "$undefined", "NL", "SHM", "GENERATE", "PURGE",
  "START", "CONTROLLER", "MODEL", "REPO", "SERVICE", "HELP", "VERSION",
  "REST", "MAPPING", "LOGIN", "CONSTRUCTOR", "GETSET", "SETCRUD",
  "INTEGER", "WORD", "$accept", "run", "line", "com", "command", "make",
  "create", "delete", "do", "gen_option", "controller",
  "controller_action", "model", "model_action", "repo", "repo_action",
  "service", "service_action", "flags", "flag", "flag_opt", YY_NULLPTR
};
#endif
...
{
       4,   -21,    -1,    27,   -21,   -21,    29,   -20,   -18,   -21,
     -21,   -21,   -21,   -21,   -21,   -21,   -21,     6,   -21,   -21,
     -21,   -21,   -21,   -21,   -11,   -21,   -21,     8,    12,    14,
      20,   -21,   -21,     7,   -21,     7,   -21,     7,   -21,     7,
...
{
       0,     4,     0,     0,     3,     5,     0,     0,     0,    40,
      41,    42,    43,    44,    45,    46,    47,     0,     7,     9,
      11,    12,    10,     8,    38,     1,     2,    22,    26,    30,
      34,    15,    16,    20,    17,    24,    18,    28,    19,    32,
      14,    13,     6,    39,    23,    27,    31,    35,    21,    36,
      25,    29,    33,    37
};
...
{
      23,    40,     5,    41,     6,     7,     8,     1,     2,    42,
      43,     9,    10,    11,    12,    13,    14,    15,    16,     9,
      10,    11,    12,    13,    14,    15,    16,    25,    26,    44,
       1,     2,    50,    45,    51,    46,    52,    27,    28,    29,
      30,    47,     0,     0,     0,     0,    53,     0,    53,    53,
      53
};

static const yytype_int8 yycheck[] =
{
       2,    21,     3,    21,     5,     6,     7,     3,     4,     3,
      21,    12,    13,    14,    15,    16,    17,    18,    19,    12,
      13,    14,    15,    16,    17,    18,    19,     0,     3,    21,
       3,     4,    35,    21,    37,    21,    39,     8,     9,    10,
      11,    21,    -1,    -1,    -1,    -1,    48,    -1,    50,    51,
      52
};
...
{
       0,     3,     4,    23,    24,     3,     5,     6,     7,    12,
      13,    14,    15,    16,    17,    18,    19,    25,    26,    27,
      28,    29,    30,    41,    42,     0,    24,     8,     9,    10,
      11,    31,    32,    33,    34,    35,    36,    37,    38,    39,
      21,    21,     3,    21,    21,    21,    21,    21,    40,    41,
      40,    40,    40,    41
};
...
#line 1406 "y.tab.c"
  ...
  case 13:
#line 84 "shmCLI.y"
                           { char *name = (yyvsp[0].charVal); create(name); }
#line 1412 "y.tab.c"
    break;

  case 14:
#line 87 "shmCLI.y"
                           { char *name = (yyvsp[0].charVal); purge(name); }
#line 1418 "y.tab.c"
    break;

  case 20:
#line 98 "shmCLI.y"
                                                                { char *name = (yyvsp[0].charVal); makeController(name, ""); }
#line 1424 "y.tab.c"
    break;

  case 21:
#line 99 "shmCLI.y"
                                                                { char *name = (yyvsp[-1].charVal); char *opt = (yyvsp[0].charVal); makeController(name, opt);}
#line 1430 "y.tab.c"
    break;

  case 22:
#line 102 "shmCLI.y"
                                                                { (yyval.charVal) = "default"; }
#line 1436 "y.tab.c"
    break;
...
#line 1442 "y.tab.c"
  ...
  case 24:
#line 106 "shmCLI.y"
                                        { char *name = (yyvsp[0].charVal); makeModel("default", ""); }
#line 1448 "y.tab.c"
    break;

  case 25:
#line 107 "shmCLI.y"
                                        { char *name = (yyvsp[-1].charVal); char *opt = (yyvsp[0].charVal); makeModel(name, opt); }
#line 1454 "y.tab.c"
    break;
...
#line 1466 "y.tab.c"
  ...
  case 28:
#line 114 "shmCLI.y"
                                                { char *name = (yyvsp[0].charVal); makeRepo(name, ""); }
#line 1472 "y.tab.c"
    break;

  case 29:
#line 115 "shmCLI.y"
                                                { char *name = (yyvsp[-1].charVal); char *opt = (yyvsp[0].charVal); makeRepo(name, opt); }
#line 1478 "y.tab.c"
    break;
...
#line 1490 "y.tab.c"
  ...
  case 32:
#line 122 "shmCLI.y"
                                                { char *name = (yyvsp[0].charVal); makeService(name, ""); }
#line 1496 "y.tab.c"
    break;

  case 33:
#line 123 "shmCLI.y"
                                                { char *name = (yyvsp[-1].charVal); char *opt = (yyvsp[0].charVal); makeService(name, opt); }
#line 1502 "y.tab.c"
    break;
...
#line 1514 "y.tab.c"
  ...
  case 37:
#line 131 "shmCLI.y"
                                { 	char *val = (yyvsp[-1].charVal); char *spec = (yyvsp[0].charVal); 
							char aux[100]; 
							strcpy(aux, val);
							strcat(aux, " ");
							strcat(aux, spec);
...
#line 1566 "y.tab.c"
  ...
  case 45:
#line 153 "shmCLI.y"
                                        { (yyval.charVal) = "constructor"; }
#line 1572 "y.tab.c"
    break;

  case 46:
#line 154 "shmCLI.y"
                                                { (yyval.charVal) = "getset"; }
#line 1578 "y.tab.c"
    break;

  case 47:
#line 155 "shmCLI.y"
                                                { (yyval.charVal) = "setCrud"; }
#line 1584 "y.tab.c"
    break;
